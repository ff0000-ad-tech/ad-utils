...
var TextUtils = new function () {
	...
	self.autosizeTF = function (target, fontAdjustmentFactor) {
		...
		if (Styles$1.getWidth(elem) > maxWidth || Styles$1.getHeight(elem) > maxHeight) TextUtils.autosizeTF(elem);else return currentFontSize ? currentFontSize : Styles$1.getCss(elem, 'font-size');
	};
	...
	self.matchTeamNameSize = function (team1Element, team2Element) {
		...
		Styles$1.setCss(team1Element, { fontSize: smallestFontSize });
		Align.moveX(Align.CENTER, team1Element);
		Styles$1.setCss(team2Element, { fontSize: smallestFontSize });
...
/**
	...
	@example
		...
		// your val should be 'I am prop2'
*/
objectifier$1.get = function (str, ctxObj) {
	ctxObj = ctxObj || window;
	var splits = objectifier$1._getSplits(str).splits;
	return objectifier$1._getProperty(splits, ctxObj);
};
...
/**
	...
	@example
		...
		// myObj.prop2.string is now 'hello'
*/
objectifier$1.set = function (str, val, ctxObj) {
	ctxObj = ctxObj || window;
	var splitData = objectifier$1._getSplits(str, true);
	var result = objectifier$1._getProperty(splitData.splits, ctxObj);
	result[splitData.lastKey] = val;
};

// objectifier._getSplits and objectifier._getProperty  are used internally for objectifier.get and objectifier.set
objectifier$1._getSplits = function (str, popLast) {
	var splits = str.split('.');
	var lastKey = popLast ? splits.pop() : null;
...
objectifier$1._getProperty = function (splits, obj) {
	var result = obj || {};
	var i;
	var s;
	for (i = 0; result && (s = splits[i]); i++) {
...
/**
	...
	@example
		...
		at module-level so "default" would conflict with keyword
*/
function objDefault$1(obj, defaultObj, recursive) {
	obj = obj || {};

	var result = clone$1(obj);
	...
	for (var key in defaultObj) {
		...
		if (result[key] === undefined) {
			...
			if (Object.prototype.toString.call(item) === '[object Object]') {
				result[key] = objDefault$1(result[key], item, recursive);
			}
		}
	}
...
var ObjectUtils$1$1 = Object.freeze({
	clone: clone$1,
	default: objDefault$1,
	objectifier: objectifier$1
});
...
*/
function toRgba$1(color, alpha) {
	switch (typeof color === 'undefined' ? 'undefined' : _typeof$1(color)) {
		case 'object':
			color = color || {
				r: 0,
				g: 0,
...
*/
function toRgbaString$1(color, alpha) {
	var color = toRgba$1(color, alpha);
...
function saturation(obj) {
	...
	}return obj.format === 'object' ? returnColors : toRgbaString$1(returnColors);
}
...
function _convert(obj) {
	...
	if (obj.from && _typeof$1(obj.from) !== 'object') obj.from = ColorUtils.toRgba(obj.from);
	if (obj.to && _typeof$1(obj.to) !== 'object') obj.to = ColorUtils.toRgba(obj.to);
	//
...
var ColorUtils$1 = Object.freeze({
	toRgba: toRgba$1,
...
/**
		...
		@example
				...
				MathUtils.random ( 1, 3, 0.5 )  // returns 1, 1.5, 2, 2.5 or 3
*/
function random$1(a, b, increment) {
		b = b || 0;
		increment = increment != undefined && increment > 0 ? increment : 1;
...
var MathUtils$1 = Object.freeze({
	...
	randomWeightedKey: randomWeightedKey,
	rel: rel,
	inRange: inRange,
	isNumber: isNumber,
	toNumber: toNumber,
...
var ImageUtils = Object.freeze({
	fitImageAtCoordinate: fitImageAtCoordinate
});
...
export { ArrayUtils, ColorUtils$1 as ColorUtils, DcsUtils, ImageUtils, LocationUtils, MathUtils$1 as MathUtils, ObjectUtils$1$1 as ObjectUtils, TextUtils, NetUtils };

 ...
 * @description Returns the specified number of '&nbsp;' strings.
 ...
 * @description Returns entity equivilent for specified character.
 * @returns The modified String
 */
 ...
 * @param {String} target
 * string to affect
 * @description Removes white space from the start and end of a string.
 * @returns The modified String
 */
 ...
 * @description Removes all white space from the string.
 * @returns The modified String
 */
 ...
 * @description Pads a number with zeros up to the specified number of places.
 * @returns The modified String
 */
